...
using std::string;
  ...
  */
CONTRACT tokenfutbol : public contract {
  public:
     ...
     using create_action = eosio::action_wrapper<"create"_n, &tokenfutbol::create>;
     using issue_action = eosio::action_wrapper<"issue"_n, &tokenfutbol::issue>;
     using retire_action = eosio::action_wrapper<"retire"_n, &tokenfutbol::retire>;
     using transfer_action = eosio::action_wrapper<"transfer"_n, &tokenfutbol::transfer>;
     using open_action = eosio::action_wrapper<"open"_n, &tokenfutbol::open>;
     using close_action = eosio::action_wrapper<"close"_n, &tokenfutbol::close>;
  private:
